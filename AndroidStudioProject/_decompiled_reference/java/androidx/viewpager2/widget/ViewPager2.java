...
public final class ViewPager2 extends ViewGroup {
    ...
    int mCurrentItem;
    private RecyclerView.AbstractC0418j mCurrentItemDataSetChangeObserver;
    ...
    private C0456q mPagerSnapHelper;
    private Parcelable mPendingAdapterState;
    private int mPendingCurrentItem;
    RecyclerView mRecyclerView;
    private RecyclerView.AbstractC0422n mSavedItemAnimator;
    ...
    public class BasicAccessibilityProvider extends AccessibilityProvider {
        ...
        @Override // androidx.viewpager2.widget.ViewPager2.AccessibilityProvider
        public void onLmInitializeAccessibilityNodeInfo(C6008t4 c6008t4) {
            if (ViewPager2.this.isUserInputEnabled()) {
                return;
            }
            c6008t4.m48036g0(C6008t4.a.f39018k);
            c6008t4.m48036g0(C6008t4.a.f39017j);
    ...
    public class LinearLayoutManagerImpl extends LinearLayoutManager {
        ...
        public void calculateExtraLayoutSpace(RecyclerView.C0406b0 c0406b0, int[] iArr) {
            ...
            if (offscreenPageLimit == -1) {
                super.calculateExtraLayoutSpace(c0406b0, iArr);
                return;
            }
        ...
        public void onInitializeAccessibilityNodeInfo(RecyclerView.C0431w c0431w, RecyclerView.C0406b0 c0406b0, C6008t4 c6008t4) {
            ...
            ViewPager2.this.mAccessibilityProvider.onLmInitializeAccessibilityNodeInfo(c6008t4);
        }
        ...
        public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.C0431w c0431w, RecyclerView.C0406b0 c0406b0, View view, C6008t4 c6008t4) {
            ViewPager2.this.mAccessibilityProvider.onLmInitializeAccessibilityNodeInfoForItem(view, c6008t4);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.AbstractC0425q
        public boolean performAccessibilityAction(RecyclerView.C0431w c0431w, RecyclerView.C0406b0 c0406b0, int i, Bundle bundle) {
            return ViewPager2.this.mAccessibilityProvider.handlesLmPerformAccessibilityAction(i) ? ViewPager2.this.mAccessibilityProvider.onLmPerformAccessibilityAction(i) : super.performAccessibilityAction(c0431w, c0406b0, i, bundle);
        }
    ...
    public class PageAwareAccessibilityProvider extends AccessibilityProvider {
        private final InterfaceC6721w4 mActionPageBackward;
        private final InterfaceC6721w4 mActionPageForward;
        private RecyclerView.AbstractC0418j mAdapterDataObserver;

        public PageAwareAccessibilityProvider() {
            super();
            this.mActionPageForward = new InterfaceC6721w4() { // from class: androidx.viewpager2.widget.ViewPager2.PageAwareAccessibilityProvider.1
            ...
            this.mActionPageBackward = new InterfaceC6721w4() { // from class: androidx.viewpager2.widget.ViewPager2.PageAwareAccessibilityProvider.2
                @Override // p000.InterfaceC6721w4
                public boolean perform(View view, InterfaceC6721w4.a aVar) {
                    PageAwareAccessibilityProvider.this.setCurrentItemFromAccessibilityCommand(((ViewPager2) view).getCurrentItem() - 1);
                    return true;
        ...
        private void addCollectionInfo(C6008t4 c6008t4) {
            int i;
            int i2;
            ...
            c6008t4.m48060t0(C6008t4.e.m48086b(i2, i, false, 0));
        }

        private void addCollectionItemInfo(View view, C6008t4 c6008t4) {
            c6008t4.m48062u0(C6008t4.f.m48087a(ViewPager2.this.getOrientation() == 1 ? ViewPager2.this.mLayoutManager.getPosition(view) : 0, 1, ViewPager2.this.getOrientation() == 0 ? ViewPager2.this.mLayoutManager.getPosition(view) : 0, 1, false, false));
        }

        private void addScrollActions(C6008t4 c6008t4) {
            int itemCount;
            RecyclerView.AbstractC0416h adapter = ViewPager2.this.getAdapter();
        ...
        @Override // androidx.viewpager2.widget.ViewPager2.AccessibilityProvider
        public void onAttachAdapter(RecyclerView.AbstractC0416h<?> abstractC0416h) {
            updatePageAccessibilityActions();
            if (abstractC0416h != null) {
                abstractC0416h.registerAdapterDataObserver(this.mAdapterDataObserver);
            }
        }

        @Override // androidx.viewpager2.widget.ViewPager2.AccessibilityProvider
        public void onDetachAdapter(RecyclerView.AbstractC0416h<?> abstractC0416h) {
            if (abstractC0416h != null) {
                abstractC0416h.unregisterAdapterDataObserver(this.mAdapterDataObserver);
            }
        }
        ...
        public void onInitialize(CompositeOnPageChangeCallback compositeOnPageChangeCallback, RecyclerView recyclerView) {
            ...
            this.mAdapterDataObserver = new DataSetChangeObserver() { // from class: androidx.viewpager2.widget.ViewPager2.PageAwareAccessibilityProvider.3
                @Override // androidx.viewpager2.widget.ViewPager2.DataSetChangeObserver, androidx.recyclerview.widget.RecyclerView.AbstractC0418j
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            addCollectionInfo(m47968k1);
            addScrollActions(m47968k1);
        }

        @Override // androidx.viewpager2.widget.ViewPager2.AccessibilityProvider
        public void onLmInitializeAccessibilityNodeInfoForItem(View view, C6008t4 c6008t4) {
            addCollectionItemInfo(view, c6008t4);
        }
        ...
        public void updatePageAccessibilityActions() {
            ...
            tu5.m49783j0(viewPager2, R.id.accessibilityActionPageLeft);
            tu5.m49783j0(viewPager2, R.id.accessibilityActionPageRight);
            tu5.m49783j0(viewPager2, R.id.accessibilityActionPageUp);
            tu5.m49783j0(viewPager2, R.id.accessibilityActionPageDown);
            if (ViewPager2.this.getAdapter() == null || (itemCount = ViewPager2.this.getAdapter().getItemCount()) == 0 || !ViewPager2.this.isUserInputEnabled()) {
                return;
            }
            if (ViewPager2.this.getOrientation() != 0) {
                if (ViewPager2.this.mCurrentItem < itemCount - 1) {
                    tu5.m49787l0(viewPager2, new C6008t4.a(R.id.accessibilityActionPageDown, null), null, this.mActionPageForward);
                }
                if (ViewPager2.this.mCurrentItem > 0) {
                    tu5.m49787l0(viewPager2, new C6008t4.a(R.id.accessibilityActionPageUp, null), null, this.mActionPageBackward);
                    return;
                }
                return;
            }
            ...
            if (ViewPager2.this.mCurrentItem < itemCount - 1) {
                tu5.m49787l0(viewPager2, new C6008t4.a(i2, null), null, this.mActionPageForward);
            }
            if (ViewPager2.this.mCurrentItem > 0) {
                tu5.m49787l0(viewPager2, new C6008t4.a(i, null), null, this.mActionPageBackward);
            }
        }
    }
    ...
    /* compiled from: zaffa */
    public class PagerSnapHelperImpl extends C0456q {
        ...
        public View findSnapView(RecyclerView.AbstractC0425q abstractC0425q) {
            ...
            return super.findSnapView(abstractC0425q);
        }
    }
    ...
    private RecyclerView.InterfaceC0426r enforceChildFillListener() {
        return new RecyclerView.InterfaceC0426r() { // from class: androidx.viewpager2.widget.ViewPager2.4
            @Override // androidx.recyclerview.widget.RecyclerView.InterfaceC0426r
    ...
    private void registerCurrentItemDataSetTracker(RecyclerView.AbstractC0416h<?> abstractC0416h) {
        if (abstractC0416h != null) {
            abstractC0416h.registerAdapterDataObserver(this.mCurrentItemDataSetChangeObserver);
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    private void restorePendingState() {
        RecyclerView.AbstractC0416h adapter;
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) {
        int[] iArr = C0548R.styleable.ViewPager2;
    ...
    private void unregisterCurrentItemDataSetTracker(RecyclerView.AbstractC0416h<?> abstractC0416h) {
        if (abstractC0416h != null) {
            abstractC0416h.unregisterAdapterDataObserver(this.mCurrentItemDataSetChangeObserver);
        }
    }

    public void addItemDecoration(RecyclerView.AbstractC0424p abstractC0424p) {
        this.mRecyclerView.addItemDecoration(abstractC0424p);
    }
    ...
    public RecyclerView.AbstractC0416h getAdapter() {
    ...
    public RecyclerView.AbstractC0424p getItemDecorationAt(int i) {
    ...
    public void removeItemDecoration(RecyclerView.AbstractC0424p abstractC0424p) {
        this.mRecyclerView.removeItemDecoration(abstractC0424p);
    }
    ...
    public void setAdapter(RecyclerView.AbstractC0416h abstractC0416h) {
        RecyclerView.AbstractC0416h adapter = this.mRecyclerView.getAdapter();
        this.mAccessibilityProvider.onDetachAdapter(adapter);
        unregisterCurrentItemDataSetTracker(adapter);
        this.mRecyclerView.setAdapter(abstractC0416h);
        this.mCurrentItem = 0;
        restorePendingState();
        this.mAccessibilityProvider.onAttachAdapter(abstractC0416h);
        registerCurrentItemDataSetTracker(abstractC0416h);
    }
    ...
    public void setCurrentItemInternal(int i, boolean z) {
        RecyclerView.AbstractC0416h adapter = getAdapter();
        if (adapter == null) {
    ...
    public void updateCurrentItem() {
        C0456q c0456q = this.mPagerSnapHelper;
        if (c0456q == null) {
            throw new IllegalStateException("Design assumption violated.");
        }
        View findSnapView = c0456q.findSnapView(this.mLayoutManager);
        if (findSnapView == null) {
            return;
        }
    ...
    public void addItemDecoration(RecyclerView.AbstractC0424p abstractC0424p, int i) {
        this.mRecyclerView.addItemDecoration(abstractC0424p, i);
    }
