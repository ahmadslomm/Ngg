...
public class C0451l extends RecyclerView.AbstractC0404a0 {
    ...
    public int calculateDxToMakeVisible(View view, int i) {
        RecyclerView.AbstractC0425q layoutManager = getLayoutManager();
    ...
    @SuppressLint({"UnknownNullness"})
    public void onSeekTargetStep(int i, int i2, RecyclerView.C0406b0 c0406b0, RecyclerView.AbstractC0404a0.a aVar) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
    ...
    public void onTargetFound(View view, RecyclerView.C0406b0 c0406b0, RecyclerView.AbstractC0404a0.a aVar) {
        ...
        if (calculateTimeForDeceleration > 0) {
            aVar.m3721d(-calculateDxToMakeVisible, -calculateDyToMakeVisible, calculateTimeForDeceleration, this.mDecelerateInterpolator);
        }
    }

    @SuppressLint({"UnknownNullness"})
    public void updateActionForInterimTarget(RecyclerView.AbstractC0404a0.a aVar) {
        PointF computeScrollVectorForPosition = computeScrollVectorForPosition(getTargetPosition());
        if (computeScrollVectorForPosition == null || (computeScrollVectorForPosition.x == 0.0f && computeScrollVectorForPosition.y == 0.0f)) {
            aVar.m3719b(getTargetPosition());
            stop();
            return;
        }
        ...
        aVar.m3721d((int) (this.mInterimTargetDx * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (this.mInterimTargetDy * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (calculateTimeForScrolling(10000) * TARGET_SEEK_EXTRA_SCROLL_RATIO), this.mLinearInterpolator);
    }
