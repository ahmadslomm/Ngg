...
public final class MediaBrowserCompat {
    ...
    public static class CustomActionResultReceiver extends ResultReceiver {
        ...
        public void onReceiveResult(int i, Bundle bundle) {
            ...
            StringBuilder m15222t = ee1.m15222t(i, "Unknown result code: ", " (extras=");
            m15222t.append(this.mExtras);
            m15222t.append(", resultData=");
            m15222t.append(bundle);
            m15222t.append(")");
            Log.w(MediaBrowserCompat.TAG, m15222t.toString());
        }
    }
    ...
    public static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        private final C2949hj<String, Subscription> mSubscriptions = new C2949hj<>();
        ...
        public void onConnected() {
            ...
            IBinder m16493a = C2469ex.m16493a(extras, "extra_messenger");
            if (m16493a != null) {
                this.mServiceBinderWrapper = new ServiceBinderWrapper(m16493a, this.mRootHints);
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(C2469ex.m16493a(extras, "extra_session_binder"));
            if (asInterface != null) {
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            public boolean isCurrent(String str) {
                ...
                StringBuilder m58819q = yv2.m58819q(str, " for ");
                m58819q.append(MediaBrowserImplBase.this.mServiceComponent);
                m58819q.append(" with mServiceConnection=");
                m58819q.append(MediaBrowserImplBase.this.mServiceConnection);
                m58819q.append(" this=");
                m58819q.append(this);
                Log.i(MediaBrowserCompat.TAG, m58819q.toString());
                return false;
            }
        ...
        private static String getStateLabel(int i) {
            return i != 0 ? i != 1 ? i != 2 ? i != 3 ? i != 4 ? ee1.m15213k("UNKNOWN/", i) : "CONNECT_STATE_SUSPENDED" : "CONNECT_STATE_CONNECTED" : "CONNECT_STATE_CONNECTING" : "CONNECT_STATE_DISCONNECTED" : "CONNECT_STATE_DISCONNECTING";
        }
        ...
        private boolean isCurrent(Messenger messenger, String str) {
            ...
            StringBuilder m58819q = yv2.m58819q(str, " for ");
            m58819q.append(this.mServiceComponent);
            m58819q.append(" with mCallbacksMessenger=");
            m58819q.append(this.mCallbacksMessenger);
            m58819q.append(" this=");
            m58819q.append(this);
            Log.i(MediaBrowserCompat.TAG, m58819q.toString());
            return false;
        ...
        public void connect() {
            int i = this.mState;
            if (i != 0 && i != 1) {
                throw new IllegalStateException(ee1.m15220r(new StringBuilder("connect() called while neigther disconnecting nor disconnected (state="), getStateLabel(this.mState), ")"));
            }
            this.mState = 2;
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException(ee1.m15220r(new StringBuilder("getExtras() called while not connected (state="), getStateLabel(this.mState), ")"));
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException(ee1.m15220r(new StringBuilder("getRoot() called while not connected(state="), getStateLabel(this.mState), ")"));
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException(ee1.m15218p(new StringBuilder("getServiceComponent() called while not connected (state="), this.mState, ")"));
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException(ee1.m15218p(new StringBuilder("getSessionToken() called while not connected(state="), this.mState, ")"));
        }
        ...
        public void search(final String str, final Bundle bundle, final SearchCallback searchCallback) {
            if (!isConnected()) {
                throw new IllegalStateException(ee1.m15220r(new StringBuilder("search() called while not connected (state="), getStateLabel(this.mState), ")"));
            }
            try {
                this.mServiceBinderWrapper.search(str, bundle, new SearchResultReceiver(str, bundle, searchCallback, this.mHandler), this.mCallbacksMessenger);
            } catch (RemoteException e) {
    ...
    public static class ServiceBinderWrapper {
        ...
        public void addSubscription(String str, IBinder iBinder, Bundle bundle, Messenger messenger) throws RemoteException {
            ...
            C2469ex.m16494b(bundle2, "data_callback_token", iBinder);
        ...
        public void removeSubscription(String str, IBinder iBinder, Messenger messenger) throws RemoteException {
            Bundle bundle = new Bundle();
            bundle.putString("data_media_item_id", str);
            C2469ex.m16494b(bundle, "data_callback_token", iBinder);
    ...
    public static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int i = 0; i < this.mOptionsList.size(); i++) {
                if (zv2.m60184a(this.mOptionsList.get(i), bundle)) {
