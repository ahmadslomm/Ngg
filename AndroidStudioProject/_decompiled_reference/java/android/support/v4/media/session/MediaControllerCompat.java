...
public final class MediaControllerCompat {
    ...
    /* compiled from: zaffa */
    public static class MediaControllerExtraData extends xa0.C6889a {
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        if (activity instanceof xa0) {
            MediaControllerExtraData mediaControllerExtraData = (MediaControllerExtraData) ((xa0) activity).getExtraData(MediaControllerExtraData.class);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        if (activity instanceof xa0) {
            ((xa0) activity).putExtraData(new MediaControllerExtraData(mediaControllerCompat));
        }
    ...
    public static void validateCustomAction(String str, Bundle bundle) {
        ...
        if (str.equals(MediaSessionCompat.ACTION_FOLLOW) || str.equals(MediaSessionCompat.ACTION_UNFOLLOW)) {
            if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                throw new IllegalArgumentException(yv2.m58814l("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action ", str, "."));
            }
        }
    }
        ...
        public static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            public void onReceiveResult(int i, Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.mLock) {
                    mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(C2469ex.m16493a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
