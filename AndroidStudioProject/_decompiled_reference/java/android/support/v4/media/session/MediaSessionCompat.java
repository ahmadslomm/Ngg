...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((vw2) message.obj);
                }
            }
        }
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            C2469ex.m16494b(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, asBinder);
        ...
        public void handleMediaPlayPauseKeySingleTapIfPending(vw2 vw2Var) {
            if (this.mMediaPlayPauseKeyPending) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(vw2Var);
                if (z && z3) {
                    onPause();
                } else if (!z && z2) {
                    onPlay();
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            vw2 currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(vw2 vw2Var);
        ...
        void setPlaybackToRemote(tx5 tx5Var);
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(vw2 vw2Var) {
        }
    }
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public String toString() {
            ...
            sb.append(", Id=");
            return yv2.m58812j(this.mId, " }", sb);
        }
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(C2469ex.m16493a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
        ...
        public Bundle toBundle() {
            ...
            if (iMediaSession != null) {
                C2469ex.m16494b(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
            }
    ...
    public void setPlaybackToRemote(tx5 tx5Var) {
    ...
    private MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (context != null) {
            if (!TextUtils.isEmpty(str)) {
                if (componentName == null && (componentName = aw2.m5039a(context)) == null) {
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public vw2 getCurrentControllerInfo() {
            return null;
        }
        ...
        public class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new vw2(callingPackage, Binder.getCallingPid(), Binder.getCallingUid()));
            }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private tx5.AbstractC6267a mVolumeCallback = new tx5.AbstractC6267a() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // p000.tx5.AbstractC6267a
            public void onVolumeChanged(tx5 tx5Var) {
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new vw2("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new vw2(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
