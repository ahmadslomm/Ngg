...
public abstract class RtcEngineEx extends RtcEngine {
    ...
    public abstract int enableVideoImageSourceEx(boolean z, ImageTrackOptions imageTrackOptions, RtcConnection rtcConnection);
    ...
    public abstract int playEffectEx(RtcConnection rtcConnection, int i, String str, int i2, double d, double d2, double d3, boolean z);

    public abstract int playEffectEx(RtcConnection rtcConnection, int i, String str, int i2, double d, double d2, double d3, boolean z, int i3);

    public abstract int preloadEffectEx(RtcConnection rtcConnection, int i, String str);

    public abstract int preloadEffectEx(RtcConnection rtcConnection, int i, String str, int i2);
