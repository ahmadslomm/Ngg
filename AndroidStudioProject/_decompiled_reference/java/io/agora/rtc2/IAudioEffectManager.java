...
public interface IAudioEffectManager {
    ...
    int playEffectEx(RtcConnection rtcConnection, int i, String str, int i2, double d, double d2, double d3, boolean z);

    int playEffectEx(RtcConnection rtcConnection, int i, String str, int i2, double d, double d2, double d3, boolean z, int i3);

    int preloadEffect(int i, String str);

    int preloadEffect(int i, String str, int i2);

    int preloadEffectEx(RtcConnection rtcConnection, int i, String str);

    int preloadEffectEx(RtcConnection rtcConnection, int i, String str, int i2);
