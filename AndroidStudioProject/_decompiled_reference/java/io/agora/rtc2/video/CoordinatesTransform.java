...
public class CoordinatesTransform {
    ...
    public static Rect calculateMeteringArea(float f, float f2, int i, int i2, float f3) {
        ...
        int intValue = Float.valueOf(f3 * 300.0f).intValue() / 2;
        RectF rectF = new RectF(clamp(i3 - intValue, 0, i), clamp(i4 - intValue, 0, i2), clamp(i3 + intValue, 0, i), clamp(i4 + intValue, 0, i2));
        Rect rect = new Rect();
        rectF.round(rect);
        return (rect.width() == 0 || rect.height() == 0) ? new Rect(0, 0, 0, 0) : rect;
    }

    public static RectF cameraToNormalized(RectF rectF) {
    ...
    public static RectF normalizedToCamera(RectF rectF) {
    ...
    public static RectF normalizedToSensor(RectF rectF, int i, int i2, int i3, int i4, int i5, boolean z) {
        RectF rectF2 = null;
        if (rectF == null) {
            return null;
        }
    ...
    public static RectF normalizedToView(RectF rectF, int i, int i2, int i3, int i4, boolean z, int i5, int i6) {
        RectF rectF2 = null;
        if (rectF == null) {
            return null;
        }
    ...
    public static RectF sensorToNormalized(RectF rectF, int i, int i2, int i3, int i4, boolean z) {
        RectF rectF2 = null;
        if (rectF == null) {
            return null;
        }
    ...
    public static RectF viewToNormalized(RectF rectF, int i, int i2, int i3, int i4, boolean z, int i5, int i6) {
        RectF rectF2 = null;
        if (rectF == null) {
            return null;
        }
