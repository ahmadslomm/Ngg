...
public final class EglCore {
    ...
    public void checkEglError(String str) {
        ...
        throw new IllegalStateException(m58819q.toString());
    }
    ...
    public EGLConfig getConfig(int i, int i2) {
        ...
        Logging.m23899d(TAG, "unable to find RGB8888 / " + i2 + " EGLConfig");
        return null;
    }

    public void makeCurrent(EGLSurface eGLSurface) {
        if (this.mEGLDisplay == EGL14.EGL_NO_DISPLAY) {
            Logging.m23899d(TAG, "NOTE: makeCurrent w/o display");
        }
    ...
    public EglCore(EGLContext eGLContext, int i) {
        ...
        Logging.m23899d(TAG, "EGLContext created, client version " + iArr2[0]);
    }
}
