...
public class MetaBundleInfo {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("MetaBundleInfo{mBundleId=");
        sb.append(this.mBundleId);
        sb.append(", mSceneId=");
        sb.append(this.mSceneId);
        sb.append(", mBundleType=");
        sb.append(this.mBundleType);
        sb.append(", mBundleCode='");
        sb.append(this.mBundleCode);
        sb.append("', mBundleName='");
        sb.append(this.mBundleName);
        sb.append("', mDescription='");
        sb.append(this.mDescription);
        sb.append("', mBundlePath='");
        sb.append(this.mBundlePath);
        sb.append("', mThumbnailPath='");
        sb.append(this.mThumbnailPath);
        sb.append("', mAssets='");
        sb.append(this.mAssets);
        sb.append("', mExtraInfo='");
        sb.append(this.mExtraInfo);
        sb.append("', mBundleSize=");
        return ee1.m15219q(sb, this.mBundleSize, '}');
    }
