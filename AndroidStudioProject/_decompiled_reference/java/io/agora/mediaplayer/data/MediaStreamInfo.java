...
public class MediaStreamInfo {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("MediaStreamInfo{streamIndex=");
        sb.append(this.streamIndex);
        sb.append(", mediaStreamType=");
        sb.append(this.mediaStreamType);
        sb.append(", codecName='");
        ...
        sb.append(", duration=");
        return ee1.m15219q(sb, this.duration, '}');
    }
