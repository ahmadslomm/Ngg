...
public class NV21Buffer implements VideoFrame.Buffer {
    ...
    public VideoFrame.Buffer cropAndScale(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        nativeCropAndScale(i, i2, i3, i4, i5, i6, this.data, i8, i9, allocate.getDataY(), allocate.getStrideY(), allocate.getDataU(), allocate.getStrideU(), allocate.getDataV(), allocate.getStrideV());
        return allocate;
    }
    ...
    public NV21Buffer(int i, int i2, int i3, int i4, ByteBuffer byteBuffer, Runnable runnable) {
