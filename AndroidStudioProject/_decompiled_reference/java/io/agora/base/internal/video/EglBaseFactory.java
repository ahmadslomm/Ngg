...
public class EglBaseFactory {
    public static EglBase create(EglBase.Context context, int i, boolean z, EglBase.EglConfigType eglConfigType) {
    ...
    public static EglBase.Context createEgl10Context(EGLContext eGLContext) {
    ...
    public static EglBase.Context createEgl14Context(android.opengl.EGLContext eGLContext) {
        return new EglBase14.Context(eGLContext);
    }

    public static boolean isEglBase14(EglBase.Context context) {
