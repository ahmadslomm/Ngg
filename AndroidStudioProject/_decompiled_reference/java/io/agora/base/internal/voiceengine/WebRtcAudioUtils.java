...
public final class WebRtcAudioUtils {
    ...
    private static void logAudioDeviceInfo(String str, AudioManager audioManager) {
        if (runningOnMarshmallowOrHigher()) {
            ...
            Logging.m23865d(str, "Audio Devices: ");
    ...
    private static void logAudioStateBasic(String str, AudioManager audioManager) {
        Logging.m23865d(str, "Audio State: audio mode: " + modeToString(audioManager.getMode()) + ", has mic: " + hasMicrophone() + ", mic muted: " + audioManager.isMicrophoneMute() + ", music active: " + audioManager.isMusicActive() + ", speakerphone: " + audioManager.isSpeakerphoneOn() + ", BT SCO: " + audioManager.isBluetoothScoOn());
    }
    ...
    private static void logAudioStateVolume(String str, AudioManager audioManager) {
        ...
        Logging.m23865d(str, "Audio State: ");
        if (runningOnLollipopOrHigher()) {
            z = audioManager.isVolumeFixed();
            Logging.m23865d(str, "  fixed volume=" + z);
        } else {
            z = false;
        }
        if (z) {
    ...
    public static void logDeviceInfo(String str) {
        Logging.m23865d(str, "Android SDK: " + Build.VERSION.SDK_INT + ", Release: " + Build.VERSION.RELEASE + ", Brand: " + Build.BRAND + ", Device: " + Build.DEVICE + ", Id: " + Build.ID + ", Hardware: " + Build.HARDWARE + ", Manufacturer: " + Build.MANUFACTURER + ", Model: " + Build.MODEL + ", Product: " + Build.PRODUCT);
    }
    ...
    public static synchronized void setWebRtcBasedAutomaticGainControl(boolean z) {
        synchronized (WebRtcAudioUtils.class) {
            Logging.m23870w(TAG, "setWebRtcBasedAutomaticGainControl() is deprecated");
        }
    }
        ...
        synchronized (WebRtcAudioUtils.class) {
            try {
                if (useWebRtcBasedAcousticEchoCanceler) {
                    Logging.m23870w(TAG, "Overriding default behavior; now using WebRTC AEC!");
                }
        ...
        synchronized (WebRtcAudioUtils.class) {
            try {
                if (useWebRtcBasedNoiseSuppressor) {
                    Logging.m23870w(TAG, "Overriding default behavior; now using WebRTC NS!");
                }
