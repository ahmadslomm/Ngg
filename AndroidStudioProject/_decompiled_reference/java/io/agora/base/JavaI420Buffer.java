...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
    ...
    public static JavaI420Buffer allocate(int i, int i2) {
        ...
        return new JavaI420Buffer(i, i2, slice, i, slice2, i4, nativeAllocateByteBuffer.slice(), i4, new Runnable() { // from class: io.agora.base.JavaI420Buffer.1
    ...
    private static void checkCapacity(ByteBuffer byteBuffer, int i, int i2, int i3) {
        ...
        StringBuilder m15222t = ee1.m15222t(i4, "Buffer must be at least ", " bytes, but was ");
