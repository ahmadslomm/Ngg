...
public class LicenseClient implements ServiceConnection {
    ...
    protected static String licensePubKey = "";
    protected static boolean localCheckEnabled = true;
    protected static ImmediateTaskExecutor mainThreadRunner = null;
    protected static String packageName = "com.waig.nalo";
    ...
    private void retryOrThrow(LicenseCheckException error, boolean ignoreErrorOnFinalFailure, boolean useBackgroundService) {
        int i = this.retryNum;
        if (i < 3) {
            this.retryNum = i + 1;
            this.delayedTaskExecutor.schedule(new LicenseClient$$ExternalSyntheticLambda1(this, useBackgroundService), 1000L);
