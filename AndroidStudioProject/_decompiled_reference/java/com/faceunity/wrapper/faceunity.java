...
public class faceunity {
    ...
    public static final long FUAITYPE_FACEPROCESSOR_ARMESHV2 = 2199023255552L;
    ...
    public static final long FUAITYPE_FACEPROCESSOR_RACE = 4398046511104L;
    ...
    public static class LoadConfig {
        ...
        public static void loadLibraryWithPostfix(String str) {
            ...
            if (sLoadFUAI) {
                System.loadLibrary("fuai".concat(str));
            }
            System.loadLibrary("CNamaSDK".concat(str));
            sLoadedLibrary = true;
        }
    }
    ...
    public static native int fuGetFaceRaceResult(int i);
    ...
    public static native int fuSetUseFaceRaceDetect(boolean z);
