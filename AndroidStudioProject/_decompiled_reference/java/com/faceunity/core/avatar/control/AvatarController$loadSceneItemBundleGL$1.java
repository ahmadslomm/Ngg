...
public final class AvatarController$loadSceneItemBundleGL$1 extends oa2 implements il1<Integer, tn5> {
    ...
    public final void invoke(int i) {
        ...
        SDKController.INSTANCE.bindItemsToScene$fu_core_all_featureRelease(i, new int[]{createBundle});
    }
}
