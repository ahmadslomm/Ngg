...
public final class AvatarController$doAddAvatarScene$1 extends oa2 implements gl1<tn5> {
    ...
    public AvatarController$doAddAvatarScene$1(AvatarController avatarController, FUASceneData fUASceneData, OnSceneListener onSceneListener) {
        super(0);
