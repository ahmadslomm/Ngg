...
public final class AvatarController$doRemoveAvatarScene$1 extends oa2 implements gl1<tn5> {
    final /* synthetic */ FUASceneData $sceneData;
    final /* synthetic */ AvatarController this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AvatarController$doRemoveAvatarScene$1(AvatarController avatarController, FUASceneData fUASceneData) {
        super(0);
    ...
    public final void invoke2() {
        ...
        this.this$0.removeScene(this.$sceneData, avatarCompareData);
