...
public final class AvatarController$removeAvatarItemBundle$1 extends oa2 implements il1<Integer, tn5> {
    final /* synthetic */ FUBundleData $bundle;
    final /* synthetic */ AvatarController this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AvatarController$removeAvatarItemBundle$1(AvatarController avatarController, FUBundleData fUBundleData) {
        super(1);
