...
public final class PropContainer$mPropController$2 extends oa2 implements gl1<PropContainerController> {
    public static final PropContainer$mPropController$2 INSTANCE = new PropContainer$mPropController$2();

    public PropContainer$mPropController$2() {
        super(0);
    }
