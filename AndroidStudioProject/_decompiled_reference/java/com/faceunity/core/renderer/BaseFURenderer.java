...
public abstract class BaseFURenderer implements GLSurfaceView.Renderer {
    ...
    private final oc2 mFURenderKit$delegate = te2.m48680a(BaseFURenderer$mFURenderKit$2.INSTANCE);
    ...
    */
            ...
            if (buildFURenderInputData.getTexture() != null) {
                ...
                if (this.renderSwitch) {
                    ...
                    if (i >= this.frameFuRenderMinCount) {
                        FURenderFrameData fuRenderFrameData = fuRenderFrameData();
                        OnGlRendererListener onGlRendererListener = this.glRendererListener;
                        if (onGlRendererListener != null) {
                        ...
                        onRenderAfter(fURenderOutputData2, fuRenderFrameData);
                        OnGlRendererListener onGlRendererListener2 = this.glRendererListener;
                        if (onGlRendererListener2 != null) {
                            FURenderOutputData fURenderOutputData3 = this.currentFURenderOutputData;
                            if (fURenderOutputData3 == null) {
                                l42.m28354q();
                            }
                            onGlRendererListener2.onRenderAfter(fURenderOutputData3, fuRenderFrameData);
                        }
    ...
    public void onRenderAfter(FURenderOutputData fURenderOutputData, FURenderFrameData fURenderFrameData) {
        l42.m28344g(fURenderOutputData, "outputData");
        l42.m28344g(fURenderFrameData, "frameData");
    }
    ...
    public final void setFURenderSwitch(boolean z) {
        ...
        if (!z && (gLSurfaceView = this.gLSurfaceView) != null) {
