...
public final class VideoRenderer$mOnPhotoRecordingListener$2 extends oa2 implements gl1<OnPhotoRecordingListener> {
    final /* synthetic */ VideoRenderer this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VideoRenderer$mOnPhotoRecordingListener$2(VideoRenderer videoRenderer) {
        super(0);
    ...
    public final OnPhotoRecordingListener invoke() {
        return new OnPhotoRecordingListener() { // from class: com.faceunity.core.renderer.VideoRenderer$mOnPhotoRecordingListener$2.1
