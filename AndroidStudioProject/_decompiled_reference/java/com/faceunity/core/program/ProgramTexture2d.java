...
public class ProgramTexture2d extends Program {
    ...
    private static final String VERTEX_SHADER_CENTER_ORIGIN = "uniform mat4 uMVPMatrix;\nuniform mat4 uTexMatrix;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n    gl_Position = uMVPMatrix * aPosition;\n    vTextureCoord = (uTexMatrix * (aTextureCoord - 0.5) + 0.5).xy;\n}\n";
    private int maPositionLoc;
    private int maTextureCoordLoc;
    private int muMVPMatrixLoc;
    private int muTexMatrixLoc;

    public ProgramTexture2d(boolean z) {
        super(z ? VERTEX_SHADER : VERTEX_SHADER_CENTER_ORIGIN, FRAGMENT_SHADER_2D);
    }
    ...
    public ProgramTexture2d() {
        super(VERTEX_SHADER_CENTER_ORIGIN, FRAGMENT_SHADER_2D);
    }
}
