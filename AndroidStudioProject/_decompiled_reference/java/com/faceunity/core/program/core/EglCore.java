...
public final class EglCore {
    ...
    private void checkEglError(String str) {
        ...
        StringBuilder m58819q = yv2.m58819q(str, ": EGL error: 0x");
        m58819q.append(Integer.toHexString(eglGetError));
        throw new RuntimeException(m58819q.toString());
    }
    ...
    private EGLConfig getConfig(int i, int i2) {
        ...
        Log.w("KIT_GlUtil", "unable to find RGB8888 / " + i2 + " EGLConfig");
        return null;
    }

    public static void logCurrent(String str) {
        Log.i("KIT_GlUtil", "Current EGL (" + str + "): display=" + EGL14.eglGetCurrentDisplay() + ", context=" + EGL14.eglGetCurrentContext() + ", surface=" + EGL14.eglGetCurrentSurface(12377));
    }
    ...
    public void finalize() throws Throwable {
        try {
            if (this.mEGLDisplay != EGL14.EGL_NO_DISPLAY) {
                Log.w("KIT_GlUtil", "WARNING: EglCore was not explicitly released -- state may be leaked");
                release();
            }
        } finally {
            super.finalize();
    ...
    public EglCore(EGLContext eGLContext, int i) {
        ...
        Log.d("KIT_GlUtil", "EGLContext created, client version " + iArr2[0]);
    }
