...
public final class InAppPurchaseBillingClientWrapper {
    ...
    public static final class BillingClientStateListenerWrapper implements InvocationHandler {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) {
            ...
            try {
                ...
                l42.m28343f(method, "m");
                if (l42.m28338a(method.getName(), InAppPurchaseBillingClientWrapper.METHOD_ON_BILLING_SETUP_FINISHED)) {
                    InAppPurchaseBillingClientWrapper.Companion.isServiceConnected().set(true);
                } else {
                    String name = method.getName();
                    l42.m28342e(name, "m.name");
                    if (w25.m53889s(name, InAppPurchaseBillingClientWrapper.METHOD_ON_BILLING_SERVICE_DISCONNECTED, false, 2, null)) {
    ...
    public final class PurchaseHistoryResponseListenerWrapper implements InvocationHandler {
        ...
        public PurchaseHistoryResponseListenerWrapper(InAppPurchaseBillingClientWrapper inAppPurchaseBillingClientWrapper, Runnable runnable) {
            l42.m28343f(inAppPurchaseBillingClientWrapper, "this$0");
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) {
            ...
            try {
                ...
                if (l42.m28338a(method.getName(), InAppPurchaseBillingClientWrapper.METHOD_ON_PURCHASE_HISTORY_RESPONSE)) {
    ...
    public final class SkuDetailsResponseListenerWrapper implements InvocationHandler {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) {
            ...
            try {
                l42.m28343f(obj, "proxy");
                l42.m28343f(method, "m");
                if (l42.m28338a(method.getName(), InAppPurchaseBillingClientWrapper.METHOD_ON_SKU_DETAILS_RESPONSE)) {
                    Object obj2 = objArr == null ? null : objArr[1];
                    if (obj2 != null && (obj2 instanceof List)) {
        ...
        public final void parseSkuDetails(List<?> list) {
            ...
            try {
                l42.m28343f(list, "skuDetailsObjectList");
                for (Object obj : list) {
                    try {
                        InAppPurchaseUtils inAppPurchaseUtils = InAppPurchaseUtils.INSTANCE;
    ...
    public /* synthetic */ InAppPurchaseBillingClientWrapper(Context context, Object obj, Class cls, Class cls2, Class cls3, Class cls4, Class cls5, Class cls6, Class cls7, Method method, Method method2, Method method3, Method method4, Method method5, Method method6, Method method7, InAppPurchaseSkuDetailsWrapper inAppPurchaseSkuDetailsWrapper, pp0 pp0Var) {
    ...
    public static final void m60422queryPurchaseHistory$lambda0(InAppPurchaseBillingClientWrapper inAppPurchaseBillingClientWrapper, Runnable runnable) {
        if (CrashShieldHandler.isObjectCrashing(InAppPurchaseBillingClientWrapper.class)) {
            return;
        }
        try {
            l42.m28343f(inAppPurchaseBillingClientWrapper, "this$0");
            l42.m28343f(runnable, "$queryPurchaseHistoryRunnable");
    ...
    public final void queryPurchase(String str, Runnable runnable) {
        ...
        try {
            l42.m28343f(str, "skuType");
            l42.m28343f(runnable, "querySkuRunnable");
            InAppPurchaseUtils inAppPurchaseUtils = InAppPurchaseUtils.INSTANCE;
    ...
    public final void queryPurchaseHistory(String str, Runnable runnable) {
        ...
        try {
            l42.m28343f(str, "skuType");
            l42.m28343f(runnable, "queryPurchaseHistoryRunnable");
            queryPurchaseHistoryAsync(str, new q81(11, this, runnable));
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    }
