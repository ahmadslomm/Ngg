...
public final class PersistedEvents implements Serializable {
    ...
    public static final class SerializationProxyV1 implements Serializable {
        ...
        public SerializationProxyV1(HashMap<AccessTokenAppIdPair, List<AppEvent>> hashMap) {
            l42.m28343f(hashMap, "proxyEvents");
    ...
    public final void addEvents(AccessTokenAppIdPair accessTokenAppIdPair, List<AppEvent> list) {
        ...
        try {
            ...
            if (!this.events.containsKey(accessTokenAppIdPair)) {
                this.events.put(accessTokenAppIdPair, x70.m55719L0(list));
                return;
            }
    ...
    public final Set<Map.Entry<AccessTokenAppIdPair, List<AppEvent>>> entrySet() {
        ...
        try {
            ...
            l42.m28342e(entrySet, "events.entries");
            return entrySet;
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
            return null;
    ...
    public final Set<AccessTokenAppIdPair> keySet() {
        ...
        try {
            ...
            l42.m28342e(keySet, "events.keys");
            return keySet;
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
            return null;
    ...
    public PersistedEvents(HashMap<AccessTokenAppIdPair, List<AppEvent>> hashMap) {
        l42.m28343f(hashMap, "appEventMap");
