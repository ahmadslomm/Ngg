...
public final class AnalyticsUserIDStore {
    ...
    public static final void initStore() {
        ...
        InternalAppEventsLogger.Companion.getAnalyticsExecutor().execute(new RunnableC3025i0(3));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: initStore$lambda-0, reason: not valid java name */
    public static final void m60382initStore$lambda0() {
        INSTANCE.initAndWait();
    }
    ...
    public static final void setUserID(String str) {
        ...
        InternalAppEventsLogger.Companion.getAnalyticsExecutor().execute(new RunnableC3424j8(str, 0));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setUserID$lambda-1, reason: not valid java name */
    public static final void m60383setUserID$lambda1(String str) {
        ReentrantReadWriteLock reentrantReadWriteLock = lock;
        reentrantReadWriteLock.writeLock().lock();
        try {
            userID = str;
