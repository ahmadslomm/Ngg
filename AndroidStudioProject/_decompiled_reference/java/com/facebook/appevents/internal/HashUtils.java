...
public final class HashUtils {
    ...
    public static final String computeChecksumWithPackageManager(Context context, Long l) {
        ...
        try {
            ...
            l42.m28342e(field, "checksumClass.getField(\"TYPE_WHOLE_MD5\")");
            ...
            Object newProxyInstance = Proxy.newProxyInstance(HashUtils.class.getClassLoader(), new Class[]{cls}, new InvocationHandler() { // from class: com.facebook.appevents.internal.HashUtils$computeChecksumWithPackageManager$listener$1
                ...
                public Object invoke(Object obj2, Method method, Object[] objArr) {
                    ...
                    l42.m28343f(objArr, "objects");
                    try {
                        if (l42.m28338a(method.getName(), "onChecksumsReady") && objArr.length == 1) {
                            Object obj3 = objArr[0];
                            if (obj3 instanceof List) {
                                for (Object obj4 : (List) obj3) {
                                    if (obj4 != null) {
                                        Method method2 = obj4.getClass().getMethod("getSplitName", null);
                                        l42.m28342e(method2, "c.javaClass.getMethod(\"getSplitName\")");
                                        Method method3 = obj4.getClass().getMethod("getType", null);
                                        l42.m28342e(method3, "c.javaClass.getMethod(\"getType\")");
                                        if (method2.invoke(obj4, null) == null && l42.m28338a(method3.invoke(obj4, null), obj)) {
                                            Method method4 = obj4.getClass().getMethod("getValue", null);
                                            l42.m28342e(method4, "c.javaClass.getMethod(\"getValue\")");
                                            Object invoke = method4.invoke(obj4, null);
                                            if (invoke == null) {
                                                throw new NullPointerException("null cannot be cast to non-null type kotlin.ByteArray");
                                            }
                                            w84Var.f44131a = new BigInteger(1, (byte[]) invoke).toString(16);
                                            reentrantLock.lock();
                                            try {
    ...
    private final String computeFileMd5(File file) throws Exception {
        ...
        try {
            ...
            l42.m28342e(bigInteger, "BigInteger(1, md.digest()).toString(16)");
