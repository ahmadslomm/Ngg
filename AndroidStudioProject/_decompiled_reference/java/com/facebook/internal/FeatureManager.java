...
public final class FeatureManager {
    ...
    public enum Feature {
        ...
        Megatron(262144),
        Elora(327680),
        Login(faceunity.FUAITYPE_FACEPROCESSOR_EXPRESSION_RECOGNIZER),
        ChromeCustomTabsPrefetching(R.attr.theme),
        IgnoreAppSwitchToLoggedOut(R.id.background),
        BypassAppSwitch(R.style.Animation),
        Share(faceunity.FUAITYPE_FACEPROCESSOR_EMOTION_RECOGNIZER);
        ...
        public final String toKey() {
            return l42.m28351n("FBSDKFeature", this);
        }
    ...
    public static final Feature getFeature(String str) {
        ...
        for (Map.Entry<Feature, String[]> entry : featureMapping.entrySet()) {
            ...
            while (i < length) {
                String str2 = value[i];
                i++;
                if (w25.m53882F(str, str2, false, 2, null)) {
                    return key;
                }
            }
        }
    ...
    public static final boolean isEnabled(Feature feature) {
        ...
        if (string != null && l42.m28338a(string, FacebookSdk.getSdkVersion())) {
            return false;
        }
