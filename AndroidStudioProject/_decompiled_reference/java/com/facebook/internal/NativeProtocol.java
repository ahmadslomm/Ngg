...
public final class NativeProtocol {
    ...
    public static final class EffectTestAppInfo extends NativeAppInfo {
        ...
        public Void m60469getLoginActivity() {
            return null;
        }
        ...
        public /* bridge */ /* synthetic */ String getLoginActivity() {
            return (String) m60469getLoginActivity();
        }
    }
    ...
    public static final class MessengerAppInfo extends NativeAppInfo {
        /* renamed from: getLoginActivity, reason: collision with other method in class */
        public Void m60470getLoginActivity() {
            return null;
        }
        ...
        @Override // com.facebook.internal.NativeProtocol.NativeAppInfo
        public /* bridge */ /* synthetic */ String getLoginActivity() {
            return (String) m60470getLoginActivity();
        }
    }
    ...
    public static final class ProtocolVersionQueryResult {
        ...
        public /* synthetic */ ProtocolVersionQueryResult(pp0 pp0Var) {
            this();
        }
    ...
    private final List<NativeAppInfo> buildEffectCameraAppInfoList() {
        ...
        try {
            ArrayList m44352g = r70.m44352g(new EffectTestAppInfo());
            m44352g.addAll(buildFacebookAppList());
            return m44352g;
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
            return null;
    ...
    private final List<NativeAppInfo> buildFacebookAppList() {
        ...
        try {
            return r70.m44352g(new KatanaAppInfo(), new WakizashiAppInfo());
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
            return null;
        }
    ...
    private final Uri buildPlatformProviderVersionURI(NativeAppInfo nativeAppInfo) {
        ...
        try {
            ...
            l42.m28342e(parse, "parse(CONTENT_SCHEME + appInfo.getPackage() + PLATFORM_PROVIDER_VERSIONS)");
            return parse;
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
            return null;
    ...
    public static final Intent createInstagramIntent(Context context, String str, Collection<String> collection, String str2, boolean z, boolean z2, DefaultAudience defaultAudience, String str3, String str4, String str5, boolean z3, boolean z4, boolean z5) {
        ...
        try {
            ...
            l42.m28343f(str2, "e2e");
            l42.m28343f(defaultAudience, "defaultAudience");
            l42.m28343f(str3, "clientState");
            l42.m28343f(str4, "authType");
            InstagramAppInfo instagramAppInfo = new InstagramAppInfo();
            return validateActivityIntent(context, INSTANCE.createNativeAppIntent(instagramAppInfo, str, collection, str2, z2, defaultAudience, str3, str4, false, str5, z3, LoginTargetApp.INSTAGRAM, z4, z5, "", null, null), instagramAppInfo);
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, NativeProtocol.class);
            return null;
        }
    ...
    public static final Intent createProtocolResultIntent(Intent intent, Bundle bundle, FacebookException facebookException) {
        ...
        try {
            l42.m28343f(intent, "requestIntent");
    ...
    public static final List<Intent> createProxyAuthIntents(Context context, String str, Collection<String> collection, String str2, boolean z, boolean z2, DefaultAudience defaultAudience, String str3, String str4, boolean z3, String str5, boolean z4, boolean z5, boolean z6, String str6, String str7, String str8) {
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                Intent createNativeAppIntent = INSTANCE.createNativeAppIntent((NativeAppInfo) it.next(), str, collection, str2, z2, defaultAudience, str3, str4, z3, str5, z4, LoginTargetApp.FACEBOOK, z5, z6, str6, str7, str8);
    ...
    */
    private final TreeSet<Integer> fetchAllAvailableProtocolVersionsForAppInfo(NativeAppInfo nativeAppInfo) {
        ...
        try {
            ...
            try {
                try {
                    providerInfo = FacebookSdk.getApplicationContext().getPackageManager().resolveContentProvider(l42.m28351n(nativeAppInfo.getPackage(), PLATFORM_PROVIDER), 0);
    ...
    public static final Bundle getErrorDataFromResultIntent(Intent intent) {
        ...
        try {
            l42.m28343f(intent, "resultIntent");
    ...
    public static final FacebookException getExceptionFromErrorData(Bundle bundle) {
        ...
        try {
            ...
            return (string == null || !w25.m53890t(string, ERROR_USER_CANCELED, true)) ? new FacebookException(string2) : new FacebookOperationCanceledException(string2);
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, NativeProtocol.class);
            return null;
        }
    ...
    public static final ProtocolVersionQueryResult getLatestAvailableProtocolVersionForAction(String str, int[] iArr) {
        ...
        try {
            l42.m28343f(str, WEB_DIALOG_ACTION);
            l42.m28343f(iArr, "versionSpec");
    ...
    public static final boolean isVersionCompatibleWithBucketedIntent(int i) {
        ...
        try {
            return C5551qj.m43181J(KNOWN_PROTOCOL_VERSIONS, Integer.valueOf(i)) && i >= 20140701;
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, NativeProtocol.class);
            return false;
        }
    ...
    public static final void updateAllAvailableProtocolVersionsAsync() {
        ...
        try {
            if (protocolVersionsAsyncUpdating.compareAndSet(false, true)) {
                FacebookSdk.getExecutor().execute(new RunnableC3025i0(19));
            }
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, NativeProtocol.class);
        }
    ...
    public static final void m60468updateAllAvailableProtocolVersionsAsync$lambda1() {
        if (CrashShieldHandler.isObjectCrashing(NativeProtocol.class)) {
            return;
        }
        try {
    ...
    public static final Intent validateActivityIntent(Context context, Intent intent, NativeAppInfo nativeAppInfo) {
        ...
        try {
            ...
            l42.m28342e(str, "resolveInfo.activityInfo.packageName");
    ...
    public static final Intent validateServiceIntent(Context context, Intent intent, NativeAppInfo nativeAppInfo) {
        ...
        try {
            ...
            l42.m28342e(str, "resolveInfo.serviceInfo.packageName");
            if (FacebookSignatureValidator.validateSignature(context, str)) {
                return intent;
            }
            return null;
    ...
    public static abstract class NativeAppInfo {
        ...
        public final synchronized void fetchAvailableVersions(boolean z) {
            ...
            if (!z) {
                try {
                    ...
                    if (treeSet2 != null) {
                        if (!l42.m28338a(treeSet2 == null ? null : Boolean.valueOf(treeSet2.isEmpty()), Boolean.FALSE)) {
                        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:6:0x0016, code lost:
            ...
            if (p000.l42.m28338a(r0 == null ? null : java.lang.Boolean.valueOf(r0.isEmpty()), java.lang.Boolean.FALSE) == false) goto L9;
         */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
