...
public final class ServerProtocol {
    ...
    public static final String getDialogAuthority() {
        ...
        return ul0.m51186g(new Object[]{FacebookSdk.getFacebookDomain()}, 1, DIALOG_AUTHORITY_FORMAT, "java.lang.String.format(format, *args)");
    }
    ...
    public static final Collection<String> getErrorsProxyAuthDisabled() {
        return r70.m44360o("service_disabled", "AndroidAuthKillSwitchException");
    }

    public static final Collection<String> getErrorsUserCanceled() {
        return r70.m44360o("access_denied", "OAuthAccessDeniedException");
    }

    public static final String getFacebookGraphUrlBase() {
        m25 m25Var = m25.f23730a;
        return ul0.m51186g(new Object[]{FacebookSdk.getFacebookDomain()}, 1, GRAPH_URL_FORMAT, "java.lang.String.format(format, *args)");
    }

    public static final String getGamingDialogAuthority() {
        m25 m25Var = m25.f23730a;
        return ul0.m51186g(new Object[]{FacebookSdk.getFacebookGamingDomain()}, 1, GAMING_DIALOG_AUTHORITY_FORMAT, "java.lang.String.format(format, *args)");
    }

    public static final String getGraphUrlBase() {
        m25 m25Var = m25.f23730a;
        return ul0.m51186g(new Object[]{FacebookSdk.getGraphDomain()}, 1, GRAPH_URL_FORMAT, "java.lang.String.format(format, *args)");
    }

    public static final String getGraphUrlBaseForSubdomain(String str) {
        l42.m28343f(str, "subdomain");
        m25 m25Var = m25.f23730a;
        return ul0.m51186g(new Object[]{str}, 1, GRAPH_URL_FORMAT, "java.lang.String.format(format, *args)");
    }

    public static final String getGraphVideoUrlBase() {
        m25 m25Var = m25.f23730a;
        return ul0.m51186g(new Object[]{FacebookSdk.getGraphDomain()}, 1, GRAPH_VIDEO_URL_FORMAT, "java.lang.String.format(format, *args)");
    }

    public static final String getInstagramDialogAuthority() {
        m25 m25Var = m25.f23730a;
        return ul0.m51186g(new Object[]{FacebookSdk.getInstagramDomain()}, 1, DIALOG_AUTHORITY_FORMAT, "java.lang.String.format(format, *args)");
    }

    public static final Bundle getQueryParamsForPlatformActivityIntentWebFallback(String str, int i, Bundle bundle) {
        l42.m28343f(str, "callId");
        ...
        try {
            ...
            companion.log(loggingBehavior, 6, str2, l42.m28351n("Error creating Url -- ", e));
            return null;
            ...
            companion2.log(loggingBehavior2, 6, str3, l42.m28351n("Error creating Url -- ", e2));
            return null;
        }
    }
}
