...
public class PreinstallUtil {
    ...
    public static String getPayloadFromSystemProperty(String str, ILogger iLogger) {
        return readSystemProperty(C7391zt.m60131g(Constants.ADJUST_PREINSTALL_SYSTEM_PROPERTY_PREFIX, str), iLogger);
    }
    ...
    public static String getPayloadFromSystemPropertyReflection(String str, ILogger iLogger) {
        return readSystemPropertyReflection(C7391zt.m60131g(Constants.ADJUST_PREINSTALL_SYSTEM_PROPERTY_PREFIX, str), iLogger);
    }
