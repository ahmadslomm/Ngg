...
public class PackageFactory {
    ...
    */
    public static ActivityPackage buildDeeplinkSdkClickPackage(Uri uri, Uri uri2, long j, ActivityState activityState, AdjustConfig adjustConfig, DeviceInfo deviceInfo, GlobalParameters globalParameters, ActivityHandler.InternalState internalState) {
        String uri3;
