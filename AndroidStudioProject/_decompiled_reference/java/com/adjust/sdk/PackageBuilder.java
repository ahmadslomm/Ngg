...
public class PackageBuilder {
    ...
    public static class ActivityStateCopy {
        ...
        public ActivityStateCopy(ActivityState activityState) {
            ...
            this.f6940a = activityState.eventCount;
            this.f6941b = activityState.sessionCount;
            this.f6942c = activityState.subsessionCount;
            this.f6943d = activityState.timeSpent;
            this.f6944e = activityState.sessionLength;
            this.f6945f = activityState.uuid;
            this.f6946g = activityState.pushToken;
        }
    }
    ...
    private Map<String, String> getAdRevenueParameters(AdjustAdRevenue adjustAdRevenue) {
        ...
        addString(hashMap, "android_uuid", this.activityStateCopy.f6945f);
        ...
        addString(hashMap, "push_token", this.activityStateCopy.f6946g);
        ...
        addString(hashMap, ShareConstants.FEED_SOURCE_PARAM, adjustAdRevenue.source);
        ...
        addLong(hashMap, "session_count", this.activityStateCopy.f6941b);
        addDuration(hashMap, "session_length", this.activityStateCopy.f6944e);
        addLong(hashMap, "subsession_count", this.activityStateCopy.f6942c);
        addDuration(hashMap, "time_spent", this.activityStateCopy.f6943d);
    ...
    private Map<String, String> getClickParameters(String str) {
        ...
        addLong(hashMap, "session_count", this.activityStateCopy.f6941b);
        addDuration(hashMap, "session_length", this.activityStateCopy.f6944e);
        addString(hashMap, ShareConstants.FEED_SOURCE_PARAM, str);
        addLong(hashMap, "subsession_count", this.activityStateCopy.f6942c);
        addDuration(hashMap, "time_spent", this.activityStateCopy.f6943d);
        addString(hashMap, "updated_at", this.deviceInfo.appUpdateTime);
    ...
    public Map<String, String> getEventParameters(AdjustEvent adjustEvent) {
        ...
        addLong(hashMap, "event_count", this.activityStateCopy.f6940a);
