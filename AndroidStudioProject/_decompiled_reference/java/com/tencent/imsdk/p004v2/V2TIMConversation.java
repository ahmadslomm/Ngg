...
public class V2TIMConversation implements Serializable {
    ...
    public String getShowName() {
        ...
        if (conversation.getConversationType() == 2) {
            return !TextUtils.isEmpty(this.conversation.getGroupName()) ? this.conversation.getGroupName() : this.conversation.getGroupID();
        }
        if (this.conversation.getConversationType() == 1) {
            return !TextUtils.isEmpty(this.conversation.getC2cRemark()) ? this.conversation.getC2cRemark() : !TextUtils.isEmpty(this.conversation.getC2cNickname()) ? this.conversation.getC2cNickname() : this.conversation.getC2cUserID();
        }
        return null;
    }
