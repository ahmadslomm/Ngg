...
public abstract class V2TIMGroupManager {
    ...
    public abstract void searchCloudGroupMembers(V2TIMGroupMemberSearchParam v2TIMGroupMemberSearchParam, V2TIMValueCallback<V2TIMGroupMemberSearchResult> v2TIMValueCallback);

    public abstract void searchCloudGroups(V2TIMGroupSearchParam v2TIMGroupSearchParam, V2TIMValueCallback<V2TIMGroupSearchResult> v2TIMValueCallback);
