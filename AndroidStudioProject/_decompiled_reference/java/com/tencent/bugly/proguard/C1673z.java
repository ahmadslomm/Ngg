...
public final class C1673z {
    ...
    /* renamed from: a */
    public static final String[] f9968a = "@buglyAllChannel@".split(",");

    /* renamed from: b */
    public static final String[] f9969b = "@buglyAllChannelPriority@".split(",");

    /* renamed from: c */
    private static ActivityManager f9970c;

    /* renamed from: a */
    public static String m12220a(Context context) {
        if (context == null) {
            return null;
        }
        try {
    ...
    /* renamed from: b */
    public static PackageInfo m12224b(Context context) {
        try {
            return context.getPackageManager().getPackageInfo(m12220a(context), 0);
        } catch (Throwable th) {
            if (C1612al.m11820a(th)) {
                return null;
            }
    ...
    /* renamed from: c */
    public static String m12225c(Context context) {
    ...
    /* renamed from: d */
    public static Map<String, String> m12226d(Context context) {
        if (context == null) {
            return null;
        }
        try {
    ...
    /* renamed from: e */
    public static boolean m12227e(Context context) {
        if (context == null) {
            return false;
        }
        if (f9970c == null) {
            f9970c = (ActivityManager) context.getSystemService("activity");
        }
        try {
            ActivityManager.MemoryInfo memoryInfo = new ActivityManager.MemoryInfo();
            f9970c.getMemoryInfo(memoryInfo);
            if (!memoryInfo.lowMemory) {
                return false;
            }
            C1612al.m11824c("Memory is low.", new Object[0]);
            return true;
        } catch (Throwable th) {
            if (!C1612al.m11820a(th)) {
                th.printStackTrace();
    ...
    /* renamed from: a */
    public static String m12219a(int i) {
    ...
    /* renamed from: a */
    public static boolean m12223a(ActivityManager activityManager) {
        if (activityManager == null) {
            C1612al.m11824c("is proc running, ActivityManager is null", new Object[0]);
            return true;
        }
        List<ActivityManager.RunningAppProcessInfo> runningAppProcesses = activityManager.getRunningAppProcesses();
        if (runningAppProcesses == null) {
            C1612al.m11824c("running proc info list is empty, my proc not running.", new Object[0]);
            return false;
        }
        ...
        while (it.hasNext()) {
            if (it.next().pid == myPid) {
                C1612al.m11824c("my proc is running.", new Object[0]);
                return true;
            }
        }
        C1612al.m11824c("proc not in running proc info list, my proc not running.", new Object[0]);
        return false;
    }

    /* renamed from: a */
    public static List<String> m12221a(Map<String, String> map) {
        if (map == null) {
            return null;
        }
        try {
