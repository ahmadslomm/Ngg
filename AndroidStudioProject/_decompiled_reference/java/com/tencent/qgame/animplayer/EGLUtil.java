...
public final class EGLUtil {
    ...
    private static final Object EGL_INIT_LOCK = new Object();
    ...
    public final void start(SurfaceTexture surfaceTexture) {
        ...
        synchronized (EGL_INIT_LOCK) {
            try {
                ...
                l42.m28341d(egl, "null cannot be cast to non-null type javax.microedition.khronos.egl.EGL10");
                ...
                ALog.INSTANCE.m12248e(TAG, "error:" + th, th);
            }
            if (eGLSurface != null && !l42.m28338a(eGLSurface, EGL10.EGL_NO_SURFACE)) {
            ...
            aLog2.m12247e(TAG, sb2.toString());
        }
    }
