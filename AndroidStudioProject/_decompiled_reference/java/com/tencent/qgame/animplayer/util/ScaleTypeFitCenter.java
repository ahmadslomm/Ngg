...
public final class ScaleTypeFitCenter implements IScaleType {
    ...
    private final fl3<Integer, Integer> getFitCenterSize(int i, int i2, int i3, int i4) {
        float f = i;
        float f2 = i2;
        float f3 = i3 / i4;
        if (f / f2 > f3) {
    ...
    public FrameLayout.LayoutParams getLayoutParam(int i, int i2, int i3, int i4, FrameLayout.LayoutParams layoutParams) {
        ...
        fl3<Integer, Integer> fitCenterSize = getFitCenterSize(i, i2, i3, i4);
        int intValue = fitCenterSize.m17648a().intValue();
        int intValue2 = fitCenterSize.m17649b().intValue();
