...
public class VideoDecoderOutputBuffer extends ih3 {
    public static final int COLORSPACE_BT2020 = 3;
    public static final int COLORSPACE_BT601 = 1;
    public static final int COLORSPACE_BT709 = 2;
    public static final int COLORSPACE_UNKNOWN = 0;
    public b80 colorInfo;
    public int colorspace;
    public ByteBuffer data;
    public int decoderPrivate;
    public int height;
    public int mode;
    private final InterfaceC1278a owner;
    ...
    public VideoDecoderOutputBuffer(InterfaceC1278a interfaceC1278a) {
    }
    ...
    public void init(long j, int i, ByteBuffer byteBuffer) {
        ...
        addFlag(faceunity.FUAITYPE_HUMAN_PROCESSOR_DETECT);
