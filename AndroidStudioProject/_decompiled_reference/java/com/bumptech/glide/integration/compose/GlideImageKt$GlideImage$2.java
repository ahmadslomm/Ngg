...
public final class GlideImageKt$GlideImage$2 extends oa2 implements wl1<hd0, Integer, tn5> {
    ...
    public GlideImageKt$GlideImage$2(Object obj, String str, f03 f03Var, InterfaceC5662r7 interfaceC5662r7, ji0 ji0Var, float f, z70 z70Var, Placeholder placeholder, Placeholder placeholder2, Transition.Factory factory, il1<? super RequestBuilder<Drawable>, ? extends RequestBuilder<Drawable>> il1Var, int i, int i2, int i3) {
        super(2);
        this.$model = obj;
