...
class MultiModelLoader<Model, Data> implements ModelLoader<Model, Data> {
    private final fv3<List<Throwable>> exceptionListPool;
    ...
    public static class MultiFetcher<Data> implements DataFetcher<Data>, DataFetcher.DataCallback<Data> {
        ...
        public MultiFetcher(List<DataFetcher<Data>> list, fv3<List<Throwable>> fv3Var) {
    ...
    public MultiModelLoader(List<ModelLoader<Model, Data>> list, fv3<List<Throwable>> fv3Var) {
        this.modelLoaders = list;
        this.exceptionListPool = fv3Var;
    }
