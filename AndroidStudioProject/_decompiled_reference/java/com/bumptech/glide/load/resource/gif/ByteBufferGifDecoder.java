...
public class ByteBufferGifDecoder implements ResourceDecoder<ByteBuffer, GifDrawable> {
    ...
    private static int getSampleSize(GifHeader gifHeader, int i, int i2) {
        ...
        if (Log.isLoggable(TAG, 2) && max > 1) {
            StringBuilder m58818p = yv2.m58818p("Downsampling GIF, sampleSize: ", max, ", target dimens: [", i, "x");
            m58818p.append(i2);
            m58818p.append("], actual dimens: [");
            m58818p.append(gifHeader.getWidth());
            m58818p.append("x");
            m58818p.append(gifHeader.getHeight());
            m58818p.append("]");
