...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback, Animatable {
    ...
    private List<AbstractC2920hd> animationCallbacks;
    ...
    private void notifyAnimationEndToListeners() {
        List<AbstractC2920hd> list = this.animationCallbacks;
        if (list != null) {
            int size = list.size();
            for (int i = 0; i < size; i++) {
                this.animationCallbacks.get(i).mo9726b(this);
            }
        }
    }
    ...
    public void registerAnimationCallback(AbstractC2920hd abstractC2920hd) {
        ...
        this.animationCallbacks.add(abstractC2920hd);
    }
    ...
    public boolean unregisterAnimationCallback(AbstractC2920hd abstractC2920hd) {
        List<AbstractC2920hd> list = this.animationCallbacks;
        if (list == null || abstractC2920hd == null) {
            return false;
        }
        return list.remove(abstractC2920hd);
    }
