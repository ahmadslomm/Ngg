...
public class LoadPath<Data, ResourceType, Transcode> {
    ...
    public LoadPath(Class<Data> cls, Class<ResourceType> cls2, Class<Transcode> cls3, List<DecodePath<Data, ResourceType, Transcode>> list, fv3<List<Throwable>> fv3Var) {
        this.dataClass = cls;
