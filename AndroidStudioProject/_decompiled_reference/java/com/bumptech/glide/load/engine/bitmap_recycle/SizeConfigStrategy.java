...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    private static Bitmap.Config[] getInConfigs(Bitmap.Config config) {
        ...
        int i = C11231.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
    ...
    public String toString() {
        StringBuilder m58817o = yv2.m58817o("SizeConfigStrategy{groupedMap=");
        m58817o.append(this.groupedMap);
        m58817o.append(", sortedSizes=(");
