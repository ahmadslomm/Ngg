...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, FactoryPools.Poolable {
    ...
    private int order;
    private final fv3<DecodeJob<?>> pool;
    ...
    public DecodeJob(DiskCacheProvider diskCacheProvider, fv3<DecodeJob<?>> fv3Var) {
    ...
    private DataFetcherGenerator getNextGenerator() {
        int i = C11131.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[this.stage.ordinal()];
        if (i == 1) {
    ...
    private Stage getNextStage(Stage stage) {
        int i = C11131.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[stage.ordinal()];
        if (i == 1) {
    ...
    private void runWrapped() {
        int i = C11131.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$RunReason[this.runReason.ordinal()];
        if (i == 1) {
    ...
    public <Z> Resource<Z> onResourceDecoded(DataSource dataSource, Resource<Z> resource) {
        ...
        int i = C11131.$SwitchMap$com$bumptech$glide$load$EncodeStrategy[encodeStrategy.ordinal()];
        if (i == 1) {
    ...
    private void logWithTimeAndKey(String str, long j, String str2) {
        StringBuilder m58819q = yv2.m58819q(str, " in ");
        m58819q.append(LogTime.getElapsedMillis(j));
        m58819q.append(", load key: ");
        m58819q.append(this.loadKey);
        m58819q.append(str2 != null ? ", ".concat(str2) : "");
        m58819q.append(", thread: ");
        m58819q.append(Thread.currentThread().getName());
        Log.v(TAG, m58819q.toString());
    }
