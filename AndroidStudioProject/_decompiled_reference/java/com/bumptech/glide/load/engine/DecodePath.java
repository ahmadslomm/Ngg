...
public class DecodePath<DataType, ResourceType, Transcode> {
    ...
    private final fv3<List<Throwable>> listPool;
    ...
    public DecodePath(Class<DataType> cls, Class<ResourceType> cls2, Class<Transcode> cls3, List<? extends ResourceDecoder<DataType, ResourceType>> list, ResourceTranscoder<ResourceType, Transcode> resourceTranscoder, fv3<List<Throwable>> fv3Var) {
        this.dataClass = cls;
        this.decoders = list;
        this.transcoder = resourceTranscoder;
        this.listPool = fv3Var;
