...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f7049ix = readShort();
        this.header.currentFrame.f7050iy = readShort();
        this.header.currentFrame.f7048iw = readShort();
        this.header.currentFrame.f7047ih = readShort();
        int read = read();
        ...
        while (true) {
            try {
                ...
                if (Log.isLoggable(TAG, 3)) {
                    StringBuilder m58818p = yv2.m58818p("Error Reading Block n: ", i, " count: ", i2, " blockSize: ");
                    m58818p.append(this.blockSize);
                    Log.d(TAG, m58818p.toString(), e);
                }
                this.header.status = 1;
                return;
            }
