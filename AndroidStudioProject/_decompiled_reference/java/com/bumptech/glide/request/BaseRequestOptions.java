...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
    ...
    public T apply(BaseRequestOptions<?> baseRequestOptions) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().apply(baseRequestOptions);
        }
    ...
    public T decode(Class<?> cls) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().decode(cls);
        }
    ...
    public T diskCacheStrategy(DiskCacheStrategy diskCacheStrategy) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().diskCacheStrategy(diskCacheStrategy);
        }
    ...
    public T dontTransform() {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().dontTransform();
        }
        this.transformations.clear();
        int i = this.fields;
        this.isTransformationRequired = false;
    ...
    public T error(Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().error(drawable);
        }
    ...
    public T fallback(Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().fallback(drawable);
        }
    ...
    public T onlyRetrieveFromCache(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().onlyRetrieveFromCache(z);
        }
    ...
    public final T optionalTransform(DownsampleStrategy downsampleStrategy, Transformation<Bitmap> transformation) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().optionalTransform(downsampleStrategy, transformation);
        }
    ...
    public T override(int i, int i2) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().override(i, i2);
        }
    ...
    public T placeholder(Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().placeholder(drawable);
        }
    ...
    public T priority(Priority priority) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().priority(priority);
        }
    ...
    public T removeOption(Option<?> option) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().removeOption(option);
        }
    ...
    public <Y> T set(Option<Y> option, Y y) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().set(option, y);
        }
    ...
    public T signature(Key key) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().signature(key);
        }
    ...
    public T sizeMultiplier(float f) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().sizeMultiplier(f);
        }
        if (f < 0.0f || f > 1.0f) {
    ...
    public T skipMemoryCache(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().skipMemoryCache(true);
        }
        this.isCacheable = !z;
        this.fields |= 256;
        return selfOrThrowIfLocked();
    ...
    public T theme(Resources.Theme theme) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().theme(theme);
        }
        this.theme = theme;
        if (theme != null) {
            this.fields |= 32768;
    ...
    public final T transform(DownsampleStrategy downsampleStrategy, Transformation<Bitmap> transformation) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().transform(downsampleStrategy, transformation);
        }
        downsample(downsampleStrategy);
    ...
    public T useAnimationPool(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().useAnimationPool(z);
        }
    ...
    public T useUnlimitedSourceGeneratorsPool(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().useUnlimitedSourceGeneratorsPool(z);
        }
    ...
    public T fallback(int i) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().fallback(i);
        }
        this.fallbackId = i;
    ...
    public T placeholder(int i) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().placeholder(i);
        }
    ...
    public T transform(Transformation<Bitmap> transformation, boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().transform(transformation, z);
        }
    ...
    public <Y> T transform(Class<Y> cls, Transformation<Y> transformation, boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo60327clone().transform(cls, transformation, z);
        }
