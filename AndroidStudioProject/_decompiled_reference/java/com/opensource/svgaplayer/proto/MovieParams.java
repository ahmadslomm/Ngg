...
public final class MovieParams extends Message<MovieParams, Builder> {
    ...
    public static final class Builder extends Message.Builder<MovieParams, Builder> {
        ...
        public MovieParams build() {
            return new MovieParams(this.viewBoxWidth, this.viewBoxHeight, this.fps, this.frames, buildUnknownFields());
        }
    }
    ...
    public static final class ProtoAdapter_MovieParams extends ProtoAdapter<MovieParams> {
        ...
        public void encode(ProtoWriter protoWriter, MovieParams movieParams) throws IOException {
            ...
            if (num != null) {
                ProtoAdapter.INT32.encodeWithTag(protoWriter, 3, (int) num);
            }
            Integer num2 = movieParams.frames;
            if (num2 != null) {
                ProtoAdapter.INT32.encodeWithTag(protoWriter, 4, (int) num2);
            }
        ...
        public int encodedSize(MovieParams movieParams) {
            ...
            Integer num2 = movieParams.frames;
            return movieParams.unknownFields().m33491B() + encodedSizeWithTag3 + (num2 != null ? ProtoAdapter.INT32.encodedSizeWithTag(4, num2) : 0);
        }
    ...
    public MovieParams(Float f, Float f2, Integer num, Integer num2) {
        this(f, f2, num, num2, C4402nx.f26538e);
    }
    ...
    public MovieParams(Float f, Float f2, Integer num, Integer num2, C4402nx c4402nx) {
