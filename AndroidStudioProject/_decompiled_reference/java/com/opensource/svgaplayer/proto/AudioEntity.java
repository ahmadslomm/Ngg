...
public final class AudioEntity extends Message<AudioEntity, Builder> {
    ...
    public static final class Builder extends Message.Builder<AudioEntity, Builder> {
        ...
        public AudioEntity build() {
            return new AudioEntity(this.audioKey, this.startFrame, this.endFrame, this.startTime, this.totalTime, buildUnknownFields());
        }
    }
    ...
    public static final class ProtoAdapter_AudioEntity extends ProtoAdapter<AudioEntity> {
        public ProtoAdapter_AudioEntity() {
            super(FieldEncoding.LENGTH_DELIMITED, (Class<?>) AudioEntity.class);
        }
        ...
        public void encode(ProtoWriter protoWriter, AudioEntity audioEntity) throws IOException {
            ...
            if (num3 != null) {
                ProtoAdapter.INT32.encodeWithTag(protoWriter, 4, (int) num3);
            }
            Integer num4 = audioEntity.totalTime;
            if (num4 != null) {
                ProtoAdapter.INT32.encodeWithTag(protoWriter, 5, (int) num4);
            }
        ...
        public int encodedSize(AudioEntity audioEntity) {
            ...
            Integer num4 = audioEntity.totalTime;
            return audioEntity.unknownFields().m33491B() + encodedSizeWithTag4 + (num4 != null ? ProtoAdapter.INT32.encodedSizeWithTag(5, num4) : 0);
        }
    ...
    public AudioEntity(String str, Integer num, Integer num2, Integer num3, Integer num4) {
        this(str, num, num2, num3, num4, C4402nx.f26538e);
    }
    ...
    public AudioEntity(String str, Integer num, Integer num2, Integer num3, Integer num4, C4402nx c4402nx) {
