...
public class Banner<T, BA extends BannerAdapter<T, ? extends RecyclerView.AbstractC0414f0>> extends FrameLayout implements BannerLifecycleObserver {
    ...
    private BA mAdapter;
    private final RecyclerView.AbstractC0418j mAdapterDataObserver;
    ...
    private void initTypedArray(Context context, AttributeSet attributeSet) {
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2048R.styleable.Banner);
            this.mBannerRadius = obtainStyledAttributes.getDimensionPixelSize(C2048R.styleable.Banner_banner_radius, 0);
            this.mLoopTime = obtainStyledAttributes.getInt(C2048R.styleable.Banner_banner_loop_time, BannerConfig.LOOP_TIME);
            this.mIsAutoLoop = obtainStyledAttributes.getBoolean(C2048R.styleable.Banner_banner_auto_loop, true);
            this.mIsInfiniteLoop = obtainStyledAttributes.getBoolean(C2048R.styleable.Banner_banner_infinite_loop, true);
            this.normalWidth = obtainStyledAttributes.getDimensionPixelSize(C2048R.styleable.Banner_banner_indicator_normal_width, BannerConfig.INDICATOR_NORMAL_WIDTH);
            this.selectedWidth = obtainStyledAttributes.getDimensionPixelSize(C2048R.styleable.Banner_banner_indicator_selected_width, BannerConfig.INDICATOR_SELECTED_WIDTH);
            this.normalColor = obtainStyledAttributes.getColor(C2048R.styleable.Banner_banner_indicator_normal_color, BannerConfig.INDICATOR_NORMAL_COLOR);
            this.selectedColor = obtainStyledAttributes.getColor(C2048R.styleable.Banner_banner_indicator_selected_color, BannerConfig.INDICATOR_SELECTED_COLOR);
            this.indicatorGravity = obtainStyledAttributes.getInt(C2048R.styleable.Banner_banner_indicator_gravity, 1);
            this.indicatorSpace = obtainStyledAttributes.getDimensionPixelSize(C2048R.styleable.Banner_banner_indicator_space, 0);
            this.indicatorMargin = obtainStyledAttributes.getDimensionPixelSize(C2048R.styleable.Banner_banner_indicator_margin, 0);
            this.indicatorMarginLeft = obtainStyledAttributes.getDimensionPixelSize(C2048R.styleable.Banner_banner_indicator_marginLeft, 0);
            this.indicatorMarginTop = obtainStyledAttributes.getDimensionPixelSize(C2048R.styleable.Banner_banner_indicator_marginTop, 0);
            this.indicatorMarginRight = obtainStyledAttributes.getDimensionPixelSize(C2048R.styleable.Banner_banner_indicator_marginRight, 0);
            this.indicatorMarginBottom = obtainStyledAttributes.getDimensionPixelSize(C2048R.styleable.Banner_banner_indicator_marginBottom, 0);
            this.indicatorHeight = obtainStyledAttributes.getDimensionPixelSize(C2048R.styleable.Banner_banner_indicator_height, BannerConfig.INDICATOR_HEIGHT);
            this.indicatorRadius = obtainStyledAttributes.getDimensionPixelSize(C2048R.styleable.Banner_banner_indicator_radius, BannerConfig.INDICATOR_RADIUS);
            this.mOrientation = obtainStyledAttributes.getInt(C2048R.styleable.Banner_banner_orientation, 0);
            this.mRoundTopLeft = obtainStyledAttributes.getBoolean(C2048R.styleable.Banner_banner_round_top_left, false);
            this.mRoundTopRight = obtainStyledAttributes.getBoolean(C2048R.styleable.Banner_banner_round_top_right, false);
            this.mRoundBottomLeft = obtainStyledAttributes.getBoolean(C2048R.styleable.Banner_banner_round_bottom_left, false);
            this.mRoundBottomRight = obtainStyledAttributes.getBoolean(C2048R.styleable.Banner_banner_round_bottom_right, false);
    ...
    public Banner addBannerLifecycleObserver(aj2 aj2Var) {
        if (aj2Var != null) {
            aj2Var.getLifecycle().mo3507a(new BannerLifecycleObserverAdapter(aj2Var, this));
        }
        return this;
    }

    public Banner addItemDecoration(RecyclerView.AbstractC0424p abstractC0424p) {
        getViewPager2().addItemDecoration(abstractC0424p);
        return this;
    }
    ...
    */
    ...
    public Banner setAdapter(BA ba) {
        if (ba == null) {
            throw new NullPointerException(getContext().getString(C2048R.string.banner_adapter_null_error));
        }
        this.mAdapter = ba;
        if (!isInfiniteLoop()) {
    ...
    public Banner setIndicatorNormalColorRes(int i) {
        setIndicatorNormalColor(pi0.m36166c(getContext(), i));
        return this;
    }
    ...
    public Banner setIndicatorSelectedColorRes(int i) {
        setIndicatorSelectedColor(pi0.m36166c(getContext(), i));
        return this;
    }
    ...
    public Banner addItemDecoration(RecyclerView.AbstractC0424p abstractC0424p, int i) {
        getViewPager2().addItemDecoration(abstractC0424p, i);
        return this;
    }
    ...
    public Banner(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mAdapterDataObserver = new RecyclerView.AbstractC0418j() { // from class: com.youth.banner.Banner.1
