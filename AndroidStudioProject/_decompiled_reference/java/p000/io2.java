...
public final class io2 extends o62<ya1, d33> {
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: G0 */
    public static final tn5 m23915G0(d33 d33Var, View view, String str, boolean z) {
        WaigNalo.mWaignCt++;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: H0 */
    public static final void m23916H0(ya1 ya1Var, View view) {
        WaigNalo.mWaignCt++;
        ColiveAgoraServiceDelegateActivity.f32952B.m40471a(view.getContext(), ya1Var.m6602x());
    }

    /* renamed from: F0 */
    public void m23917F0(d33 d33Var, ya1 ya1Var) {
        WaigNalo.mWaignCt++;
        ...
        if (ya1Var != null) {
            ...
            d33Var.m12922h(R.id.r_, R.drawable.aah);
            ...
            postImageParameterFloatingStickersEventView.m39265g(true, true, new C3324ip(d33Var, 2));
            d33Var.itemView.setOnClickListener(new mp1(ya1Var, 2));
        }
    }

    /* renamed from: I0 */
    public d33 m23918I0(ViewGroup viewGroup, int i) {
        WaigNalo.mWaignCt++;
