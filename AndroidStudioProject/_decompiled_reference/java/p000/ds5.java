...
public final class ds5 extends mb4 {

    /* renamed from: b */
    public final WeakReference<Context> f11360b;

    public ds5(Context context, Resources resources) {
        super(resources);
        this.f11360b = new WeakReference<>(context);
    }

    /* renamed from: b */
    public static boolean m14041b() {
        return false;
    }

    /* renamed from: c */
    public static boolean m14042c() {
        m14041b();
        return false;
    }

    @Override // p000.mb4, android.content.res.Resources
    ...
    public Drawable getDrawable(int i) throws Resources.NotFoundException {
        Context context = this.f11360b.get();
        return context != null ? ib4.m23092h().m23106t(context, this, i) : m30557a(i);
    }
