...
public final class la7 {
    ...
    static {
        if (ca7.m7924C() && ca7.m7925D()) {
            int i = qx6.f35830a;
        }
    }

    /* renamed from: a */
    public static /* bridge */ /* synthetic */ int m28954a(byte[] bArr, int i, int i2) {
        int i3 = i2 - i;
        byte b = bArr[i - 1];
        if (i3 == 0) {
            if (b <= -12) {
    ...
    */
    public static int m28955b(String str, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int i5;
        char charAt;
    ...
    /* renamed from: c */
    public static int m28956c(String str) {
        int length = str.length();
        int i = 0;
        int i2 = 0;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static boolean m28957d(byte[] bArr, int i, int i2) {
        while (i < i2 && bArr[i] >= 0) {
            i++;
        }
        if (i >= i2) {
