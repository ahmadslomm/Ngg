...
public final class e11 extends lm5 {
    @Override // p000.ag3, p000.z66
    /* renamed from: a */
    public C2828gt mo850a(String str, EnumC6965xq enumC6965xq, int i, int i2, Map<d41, ?> map) throws a76 {
        if (enumC6965xq == EnumC6965xq.EAN_13) {
            return super.mo850a(str, enumC6965xq, i, i2, map);
        }
        throw new IllegalArgumentException("Can only encode EAN_13, but got ".concat(String.valueOf(enumC6965xq)));
    }
    ...
    public boolean[] mo851c(String str) {
        ...
        int i = d11.f10440f[Character.digit(str.charAt(0), 10)];
        ...
        for (int i2 = 1; i2 <= 6; i2++) {
            ...
            m848b += ag3.m848b(zArr, m848b, km5.f21614e[digit], false);
        }
        int m848b2 = ag3.m848b(zArr, m848b, km5.f21611b, false) + m848b;
        for (int i3 = 7; i3 <= 12; i3++) {
            m848b2 += ag3.m848b(zArr, m848b2, km5.f21613d[Character.digit(str.charAt(i3), 10)], true);
        }
