...
public final class z94 implements tz4 {
    ...
    /* renamed from: b */
    private static boolean m59317b(StackTraceElement[] stackTraceElementArr, int i, int i2) {
        int i3 = i2 - i;
    ...
    /* renamed from: c */
    private static StackTraceElement[] m59318c(StackTraceElement[] stackTraceElementArr, int i) {
        int i2;
        ...
        while (i3 < stackTraceElementArr.length) {
            ...
            if (num == null || !m59317b(stackTraceElementArr, num.intValue(), i3)) {
    ...
    public StackTraceElement[] mo31845a(StackTraceElement[] stackTraceElementArr) {
        StackTraceElement[] m59318c = m59318c(stackTraceElementArr, this.f47990a);
        return m59318c.length < stackTraceElementArr.length ? m59318c : stackTraceElementArr;
    }
}
