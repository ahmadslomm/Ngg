...
final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return ee1.m15220r(new StringBuilder(), Utils.typeToString(this.componentType), "[]");
        }
    }
    ...
    public static pb4 buffer(pb4 pb4Var) throws IOException {
        C4148mw c4148mw = new C4148mw();
        pb4Var.source().mo17023W(c4148mw);
        return pb4.create(pb4Var.contentType(), pb4Var.contentLength(), c4148mw);
    }
    ...
    public static Type getParameterUpperBound(int i, ParameterizedType parameterizedType) {
        ...
        StringBuilder m15222t = ee1.m15222t(i, "Index ", " not in range [0,");
        m15222t.append(actualTypeArguments.length);
        m15222t.append(") for ");
        m15222t.append(parameterizedType);
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i, String str, Object... objArr) {
        StringBuilder m58819q = yv2.m58819q(str, " (parameter #");
        m58819q.append(i + 1);
        m58819q.append(")");
        return methodError(method, th, m58819q.toString(), objArr);
    }
    ...
    public static RuntimeException methodError(Method method, @Nullable Throwable th, String str, Object... objArr) {
        StringBuilder m58819q = yv2.m58819q(String.format(str, objArr), "\n    for method ");
        m58819q.append(method.getDeclaringClass().getSimpleName());
        m58819q.append(".");
        m58819q.append(method.getName());
        return new IllegalArgumentException(m58819q.toString(), th);
    }
    ...
    public static RuntimeException parameterError(Method method, int i, String str, Object... objArr) {
        ...
        m58819q.append(i + 1);
        m58819q.append(")");
        return methodError(method, m58819q.toString(), objArr);
    }
}
