...
public final class Retrofit {
    ...
    final InterfaceC3023hz.a callFactory;
    ...
    public Retrofit(InterfaceC3023hz.a aVar, rv1 rv1Var, List<Converter.Factory> list, List<CallAdapter.Factory> list2, @Nullable Executor executor, boolean z) {
    ...
    public InterfaceC3023hz.a callFactory() {
    ...
    public <T> Converter<T, sa4> nextRequestBodyConverter(@Nullable Converter.Factory factory, Type type, Annotation[] annotationArr, Annotation[] annotationArr2) {
        ...
        for (int i = indexOf; i < size; i++) {
            Converter<T, sa4> converter = (Converter<T, sa4>) this.converterFactories.get(i).requestBodyConverter(type, annotationArr, annotationArr2, this);
            if (converter != null) {
                return converter;
            }
        }
    ...
    public <T> Converter<pb4, T> nextResponseBodyConverter(@Nullable Converter.Factory factory, Type type, Annotation[] annotationArr) {
        Objects.requireNonNull(type, "type == null");
        Objects.requireNonNull(annotationArr, "annotations == null");
        int indexOf = this.converterFactories.indexOf(factory) + 1;
        int size = this.converterFactories.size();
        for (int i = indexOf; i < size; i++) {
            Converter<pb4, T> converter = (Converter<pb4, T>) this.converterFactories.get(i).responseBodyConverter(type, annotationArr, this);
            if (converter != null) {
                return converter;
            }
        }
    ...
    public <T> Converter<T, sa4> requestBodyConverter(Type type, Annotation[] annotationArr, Annotation[] annotationArr2) {
        return nextRequestBodyConverter(null, type, annotationArr, annotationArr2);
    }

    public <T> Converter<pb4, T> responseBodyConverter(Type type, Annotation[] annotationArr) {
    ...
    public static final class Builder {
        ...
        @Nullable
        private InterfaceC3023hz.a callFactory;
        ...
        public Builder baseUrl(URL url) {
            ...
            return baseUrl(rv1.m45365h(url.toString()));
        }
        ...
        public Retrofit build() {
            ...
            InterfaceC3023hz.a aVar = this.callFactory;
            if (aVar == null) {
                aVar = new he3();
            }
            InterfaceC3023hz.a aVar2 = aVar;
        ...
        public Builder callFactory(InterfaceC3023hz.a aVar) {
        ...
        public Builder client(he3 he3Var) {
            Objects.requireNonNull(he3Var, "client == null");
            return callFactory(he3Var);
        }
        ...
        public Builder baseUrl(String str) {
            ...
            return baseUrl(rv1.m45365h(str));
        }
        ...
        public Builder baseUrl(rv1 rv1Var) {
            Objects.requireNonNull(rv1Var, "baseUrl == null");
            if ("".equals(rv1Var.m45377n().get(r0.size() - 1))) {
                this.baseUrl = rv1Var;
                return this;
            }
            throw new IllegalArgumentException("baseUrl must end in /: " + rv1Var);
        }
