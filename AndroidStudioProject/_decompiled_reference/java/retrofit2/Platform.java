...
class Platform {
    ...
    public Platform(boolean z) {
        ...
        if (z) {
            try {
                constructor = yh3.m57947h().getDeclaredConstructor(Class.class, Integer.TYPE);
    ...
    public Object invokeDefaultMethod(Method method, Class<?> cls, Object obj, Object... objArr) throws Throwable {
        ...
        unreflectSpecial = (constructor != null ? yh3.m57953n(constructor.newInstance(cls, -1)) : MethodHandles.lookup()).unreflectSpecial(method, cls);
