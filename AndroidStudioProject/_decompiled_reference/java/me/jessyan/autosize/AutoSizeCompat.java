...
public final class AutoSizeCompat {
    ...
    public static /* synthetic */ class C40521 {
    ...
    public static void cancelAdapt(Resources resources) {
        ...
        int i = C40521.$SwitchMap$me$jessyan$autosize$unit$Subunits[AutoSizeConfig.getInstance().getUnitsManager().getSupportSubunits().ordinal()];
        if (i != 1) {
            f = i == 2 ? 25.4f : 72.0f;
    ...
    private static void setDensity(DisplayMetrics displayMetrics, float f, int i, float f2, float f3) {
        ...
        int i2 = C40521.$SwitchMap$me$jessyan$autosize$unit$Subunits[AutoSizeConfig.getInstance().getUnitsManager().getSupportSubunits().ordinal()];
        if (i2 == 1) {
