...
public class ActivityLifecycleCallbacksImpl implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        if (AutoSizeConfig.getInstance().isCustomFragment()) {
            if (this.mFragmentLifecycleCallbacksToAndroidx != null && (activity instanceof pj1)) {
                ((pj1) activity).getSupportFragmentManager().m58111g1(this.mFragmentLifecycleCallbacksToAndroidx, true);
            } else if (this.mFragmentLifecycleCallbacks != null && (activity instanceof pj1)) {
                ((pj1) activity).getSupportFragmentManager().m58111g1(this.mFragmentLifecycleCallbacks, true);
            }
        }
