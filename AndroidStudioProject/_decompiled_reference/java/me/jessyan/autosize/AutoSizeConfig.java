...
public final class AutoSizeConfig {
    ...
    public AutoSizeConfig init(final Application application, boolean z, AutoAdaptStrategy autoAdaptStrategy) {
        ...
        if (getInstance().getUnitsManager().getSupportSubunits() == Subunits.NONE) {
            ...
            this.mDesignHeightInDp = VideoRecordHelper.MAX_VIDEO_LENGTH;
        }
        ...
        AutoSizeLog.m30674d("designWidthInDp = " + this.mDesignWidthInDp + ", designHeightInDp = " + this.mDesignHeightInDp + ", screenWidth = " + this.mScreenWidth + ", screenHeight = " + this.mScreenHeight);
            ...
            public void onConfigurationChanged(Configuration configuration2) {
                if (configuration2 != null) {
                    if (configuration2.fontScale > 0.0f) {
                        ...
                        AutoSizeLog.m30674d("initScaledDensity = " + AutoSizeConfig.this.mInitScaledDensity + " on ConfigurationChanged");
                    }
        ...
        AutoSizeLog.m30674d("initDensity = " + this.mInitDensity + ", initScaledDensity = " + this.mInitScaledDensity);
