...
.method public static a(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources$Theme;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lmz0$a;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources$Theme;)V
...
.method public static b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 1
    invoke-static {p0}, Lmz0$a;->b(Landroid/graphics/drawable/Drawable;)Z
...
.method public static e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/ColorFilter;
    ...
    .line 1
    invoke-static {p0}, Lmz0$a;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/ColorFilter;
...
.method public static f(Landroid/graphics/drawable/Drawable;)I
    ...
    .line 1
    invoke-static {p0}, Lmz0$b;->a(Landroid/graphics/drawable/Drawable;)I
...
.method public static g(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3, p4}, Lmz0$a;->d(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
...
.method public static k(Landroid/graphics/drawable/Drawable;FF)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lmz0$a;->e(Landroid/graphics/drawable/Drawable;FF)V
...
.method public static l(Landroid/graphics/drawable/Drawable;IIII)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3, p4}, Lmz0$a;->f(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public static m(Landroid/graphics/drawable/Drawable;I)Z
    ...
    .line 1
    invoke-static {p0, p1}, Lmz0$b;->b(Landroid/graphics/drawable/Drawable;I)Z
...
.method public static n(Landroid/graphics/drawable/Drawable;I)V
    ...
    .line 1
    invoke-static {p0, p1}, Lmz0$a;->g(Landroid/graphics/drawable/Drawable;I)V
...
.method public static o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lmz0$a;->h(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
...
.method public static p(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lmz0$a;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public static q(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 6
    .line 7
    invoke-interface {p0}, Ls66;->b()Landroid/graphics/drawable/Drawable;
