...
.method private i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    .line 32
    invoke-static {v0, v1}, Ldl5;->k(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    .line 50
    invoke-static {v0, v4}, Ldl5;->k(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method private static j(Landroid/os/CancellationSignal;[Lxi1$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
...
.method public a(Landroid/content/Context;Lki1$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    .line 46
    invoke-virtual {v3}, Lki1$d;->d()Ljava/lang/String;
    ...
    .line 86
    .line 87
    invoke-direct {p0, p2, p4}, Ldl5;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[Lxi1$b;I)Landroid/graphics/Typeface;
    ...
    .line 6
    :try_start_0
    invoke-static {p2, p3, p1}, Ldl5;->j(Landroid/os/CancellationSignal;[Lxi1$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 17
    .line 18
    invoke-direct {p0, p1, p4}, Ldl5;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public c(Landroid/content/Context;Landroid/os/CancellationSignal;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    .line 12
    .line 13
    invoke-static {p2, v0, p1}, Ldl5;->j(Landroid/os/CancellationSignal;[Lxi1$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 36
    check-cast v4, [Lxi1$b;

    .line 37
    .line 38
    invoke-static {p2, v4, p1}, Ldl5;->j(Landroid/os/CancellationSignal;[Lxi1$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 53
    :cond_2
    invoke-direct {p0, v0, p4}, Ldl5;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public h([Lxi1$b;I)Lxi1$b;
    .locals 0
