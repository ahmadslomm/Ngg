...
.field private final callFactory:Lhz$a;
...
# direct methods
.method public constructor <init>(Lretrofit2/RequestFactory;[Ljava/lang/Object;Lhz$a;Lretrofit2/Converter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    .line 8
    iput-object p3, p0, Lretrofit2/OkHttpCall;->callFactory:Lhz$a;
...
.method private createRawCall()Lhz;
    .locals 3
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/OkHttpCall;->callFactory:Lhz$a;
    ...
    .line 6
    .line 7
    invoke-virtual {v1, v2}, Lretrofit2/RequestFactory;->create([Ljava/lang/Object;)Lra4;
    ...
    .line 11
    invoke-interface {v0, v1}, Lhz$a;->a(Lra4;)Lhz;
...
.method private getRawCall()Lhz;
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Lhz;
    ...
    :cond_3
    :try_start_0
    invoke-direct {p0}, Lretrofit2/OkHttpCall;->createRawCall()Lhz;
    ...
    .line 31
    iput-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Lhz;
    :try_end_0
...
.method public cancel()V
    ...
    .line 9
    .line 10
    invoke-interface {v0}, Lhz;->cancel()V
...
.method public clone()Lretrofit2/OkHttpCall;
    ...
    iget-object v3, p0, Lretrofit2/OkHttpCall;->callFactory:Lhz$a;

    iget-object v4, p0, Lretrofit2/OkHttpCall;->responseConverter:Lretrofit2/Converter;

    invoke-direct {v0, v1, v2, v3, v4}, Lretrofit2/OkHttpCall;-><init>(Lretrofit2/RequestFactory;[Ljava/lang/Object;Lhz$a;Lretrofit2/Converter;)V
...
.method public enqueue(Lretrofit2/Callback;)V
    ...
    .line 26
    iput-object v2, p0, Lretrofit2/OkHttpCall;->rawCall:Lhz;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 57
    .line 58
    invoke-static {v0, v1}, Lcom/google/firebase/perf/network/FirebasePerfOkHttpClient;->enqueue(Lhz;Lkz;)V
...
.method public execute()Lretrofit2/Response;
    ...
    .line 8
    .line 9
    invoke-direct {p0}, Lretrofit2/OkHttpCall;->getRawCall()Lhz;
    ...
    .line 21
    :cond_0
    invoke-static {v0}, Lcom/google/firebase/perf/network/FirebasePerfOkHttpClient;->execute(Lhz;)Lob4;
    ...
    .line 25
    invoke-virtual {p0, v0}, Lretrofit2/OkHttpCall;->parseResponse(Lob4;)Lretrofit2/Response;
...
.method public isCanceled()Z
    ...
    .line 11
    .line 12
    invoke-interface {v0}, Lhz;->isCanceled()Z
...
.method public parseResponse(Lob4;)Lretrofit2/Response;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 53
    .line 54
    invoke-direct {v1, v0}, Lretrofit2/OkHttpCall$ExceptionCatchingResponseBody;-><init>(Lpb4;)V
    ...
    .line 63
    invoke-static {v0, p1}, Lretrofit2/Response;->success(Ljava/lang/Object;Lob4;)Lretrofit2/Response;
    ...
    :goto_1
    :try_start_1
    invoke-static {v0}, Lretrofit2/Utils;->buffer(Lpb4;)Lpb4;
    ...
    .line 86
    invoke-static {v1, p1}, Lretrofit2/Response;->error(Lpb4;Lob4;)Lretrofit2/Response;
...
.method public declared-synchronized request()Lra4;
    .locals 3
    ...
    .line 6
    invoke-interface {v0}, Lhz;->request()Lra4;
...
.method public declared-synchronized timeout()Lme5;
    .locals 3
    ...
    .line 6
    invoke-interface {v0}, Lhz;->timeout()Lme5;
