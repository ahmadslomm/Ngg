...
.method public g()Ljava/lang/String;
    ...
    .line 6
    .line 7
    const-string v0, "UPDATE OR ABORT `waitio_session` SET `_id` = ?,`type` = ?,`uid` = ?,`distance` = ?,`unread_count` = ?,`update_time` = ?,`in_room` = ?,`online` = ?,`zone` = ?,`body` = ?,`timestamp` = ?,`nick` = ?,`avatar` = ?,`courting` = ?,`ring_id` = ?,`ring_url` = ? WHERE `_id` = ?"
...
.method public bridge synthetic j(Le55;Ljava/lang/Object;)V
    ...
    .line 8
    .line 9
    invoke-virtual {p0, p1, p2}, Lbp5$c;->l(Le55;Ll51;)V
